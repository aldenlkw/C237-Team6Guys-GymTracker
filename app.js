...
// Temporary development login fallback so the site is usable before
// a real auth system is merged.
app.get('/login', (req, res) => {
    res.redirect('/dev-login/6guys');
});

app.get('/register', (req, res) => {
    res.send('Registration is not available yet.');
});
